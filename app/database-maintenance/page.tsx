...
type TableInfo={table_name:string;estimated_rows:number|null;total_size:string};
...
export default function Page(){
 ...
 return <main style={page}><div style={eye}>twstock M8.10.9 · Turso Efficiency</div><h1>Turso 資料庫健康中心</h1><p style={muted}>M8.10.9 省讀模式：日常健康檢查不再對每張資料表執行 COUNT(*) 全表掃描。</p>
